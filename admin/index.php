...
if (isset($_POST['login'])) {
  ...
  $login = $data->adminlogin($email,$password);
  if ($login) {
    header('location:dashboard.php');
  }
}
          ...
          <div class="col-md-6">
            <div class="container center">
              ...
              <div class="log-sign-form">
                ...
                <hr class="line">
                <span><p>Don't have a Wingx account?</p></span><br/>
                <a href="signup.php" class="btn btn-up" >Sign up for Wingx</a> -->
